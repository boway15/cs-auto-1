...
- **Stack**: Infer from the repository. For this project, prefer Vite + React + TypeScript + Tailwind + shadcn/ui unless the user says otherwise.
...
```bash
python .cursor/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack react
...
| Stack | Focus |
|-------|-------|
| `react` | React/Next.js performance, component structure, rendering |
| `shadcn` | shadcn/ui component patterns and Tailwind integration |
| `html-tailwind` | HTML/CSS and Tailwind layout/styling |
...
```bash
python .cursor/skills/ui-ux-pro-max/scripts/search.py "component performance forms layout" --stack react
python .cursor/skills/ui-ux-pro-max/scripts/search.py "forms cards tables navigation" --stack shadcn
```
...
- Add the stack that matches the repo, such as `--stack react` or `--stack shadcn`, for implementation-specific guidance
